...
<body>
	...
	<form:form method="post" modelAttribute="creationDevis"
		action="creerDevis">
		<p><a href="/${cheminFonction}/creerClientAfficher">Cr�er nouveau client</a></p>
		<p><a href="/${cheminFonction}/creerModeleAfficher">Cr�er nouveau mod�le</a></p>
		<p>
		...
		<table border="1">
				<thead>
					<tr>
						<th>Mod�le - Couleur - D�lais de production - Prix de vente HT</th>
						<th>Quantit�</th>
						<th>Bt</th>
					</tr>
				</thead>
