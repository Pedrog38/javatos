...
<title>Menu Principal - Administration</title>
</head>
<body>
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="#">Menu Principal - Administration</a>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
       ...
       <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
        	<c:url value="/admin/afficherListeCommande" var="url" />
       ...
       <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
        <c:url value="/admin/stockGestion" var="url" />
       ...
       <li class="nav-item dropdown">
        ...
        <c:url value="/admin/creerModeleAfficher" var="url" />
          <a class="dropdown-item" href="${url}">Creation d'un nouveau modele</a>
          ...
          <a class="dropdown-item" href="${url}">Creation d'un nouveau client</a>
