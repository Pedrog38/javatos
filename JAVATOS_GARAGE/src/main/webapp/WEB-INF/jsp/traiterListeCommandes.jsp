...
<html>
	<head>
		...
		<title>Traiter nouvelles commandes</title>
	
	</head>
	<body>
			<h1>TRAITER NOUVELLES COMMANDES</h1>

<form:form method="post" modelAttribute="ListeAfficherCommandeForm" action="VisualiserListeCommandeNouvelle">
			<table border="1">
		<thead>
			<tr>
				<th>Id Commande</th>				
